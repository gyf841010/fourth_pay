        ...
        <div class="row">
			...
			<input type="hidden" name="id" value="<?php echo ($pa["id"]); ?>">
			 ...
			 <div class="layui-form-item">
			  ...
			  <div class="layui-form-item">
				  <label class="layui-form-label">允许回调IP：</label>
				  <div class="layui-input-block">
					<input type="text" name="pa[notify_ip]" placeholder="为空则不限制" autocomplete="off" value="<?php echo ($pa["notify_ip"]); ?>" class="layui-input">
				  </div>
			 </div>
			  <div class="layui-form-item">
				  <label class="layui-form-label">通道单笔最小金额：</label>
				  <div class="layui-input-block">
					<input type="text" name="pa[min_money]" placeholder="为空则不限制" autocomplete="off" value="<?php echo ($pa["min_money"]); ?>" class="layui-input">
				  </div>
			 </div>
			   <div class="layui-form-item">
				  <label class="layui-form-label">通道单笔最大金额：</label>
				  <div class="layui-input-block">
					<input type="text" name="pa[max_money]" placeholder="为空则不限制回调IP" autocomplete="off" value="<?php echo ($pa["max_money"]); ?>" class="layui-input">
				  </div>
			 </div>
			 <div class="layui-form-item">
			 ...
			 <div class="layui-form-item">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">浮动金额：</label>
					<div class="layui-input-inline">
						<input type="number" min="0" name="pa[fudong_money]" autocomplete="off" value="<?php echo ($pa["fudong_money"]); ?>" placeholder="" class="layui-input">
					</div>
					数字1-99，单位为分,例如填9，则浮动金额为1-9分钱
				</div>
				 <div class="layui-form-item">
	                <label class="layui-form-label">浮动金额开关：</label>
	                <div class="layui-input-block">
	                    <input type="radio" name="pa[fudong_status]" <?php if($pa['fudong_status'] == 0): ?>checked<?php endif; ?> value="0" title="关闭" checked="">
	                    <input type="radio" name="pa[fudong_status]" <?php if($pa['fudong_status'] == 1): ?>checked<?php endif; ?> value="1" title="开通">
	                </div>
	            </div>
