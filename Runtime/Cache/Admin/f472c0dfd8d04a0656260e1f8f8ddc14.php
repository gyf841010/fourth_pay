...
<div class="row">
  <div class="col-sm-12">
            ...
            <span class="input-group-addon">商户密钥：</span>
						...
						<input type="text" name="u[apikey]" autocomplete="off" value="<?php echo ($u["apikey"]); ?>" id="md5key"  class="form-control">
					</div>
				</div>
<div class="layui-form-item">
...
<select name="u[authorized]" class="form-control">
            ...
            <span class="input-group-addon">认证图片</span>
							<?php if(is_array($u['images'])): $i = 0; $__LIST__ = $u['images'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?><a class="fancybox" href="<?php echo ($img["path"]); ?>" title="点击放大查看"  target="_blank">
									<img alt="image" src="<?php echo ($img["path"]); ?>" data-src="holder.js/50x50" class="img-thumbnail" alt="50x50" style="width: 50px; height: 50px;"/>
