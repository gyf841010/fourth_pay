			...
			<!-- Basic Forms -->
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title"><?php echo ($channel['title']); ?> 子账户管理</h4>			
                        ...
                        <div class="table-responsive">
                            <table class="layui-table">
                                ...
                                <?php if(is_array($accounts)): $i = 0; $__LIST__ = $accounts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-info btn-sm" onclick="admin_edit('编辑通道账户','<?php echo U('Channel/editAccount',array('aid'=>$p[id]));?>')">编辑</button>
                                                <button class="btn btn-info btn-sm" onclick="admin_editf('编辑风控','<?php echo U('Channel/editAccountControl',array('aid'=>$p[id]));?>')">风控</button>
                                                <button class="btn btn-info btn-sm" onclick="admin_editRate('编辑费率','<?php echo U('Channel/editAccountRate',array('aid'=>$p[id]));?>')">费率</button>
