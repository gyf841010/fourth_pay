			...
			<!-- Basic Forms -->
			  <div class="box">
				<div class="box-header with-border">
				 ...
				 <h4 class="box-title"><a onclick="admin_add('添加管理员','<?php echo U('Admin/addAdmin');?>',310,520)" class="btn btn-info btn-xs" ><span class="glyphicon glyphicon-plus"></span> 添加管理员</a></h4>
					</ul>
				</div>
				<!-- /.box-header -->
                <div class="box-body">
                ...
                <table class="layui-table">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                ...
                                <a onclick="admin_edit('编辑管理员','<?php echo U('Admin/editAdmin',['id'=>$v[id]]);?>',310,520)"
