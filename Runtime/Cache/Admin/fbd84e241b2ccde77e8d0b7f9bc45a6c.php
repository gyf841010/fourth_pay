        ...
        <div class="row">
			...
			<form class="layui-form" action="" id="editRate">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="data[gudingmoney]" placeholder="固定金额列表,多个用英文,号隔开" autocomplete="off" value="<?php echo ($info["gudingmoney"]); ?>" class="layui-input">
					</div>
				</div>
					<!--div class="layui-form-item">
					<label class="layui-form-label">提交IP黑名单：</label>
					<div class="layui-input-inline">
						<input type="text" name="data[iphei]" placeholder="黑名单IP,多个用英文,号隔开" autocomplete="off" value="<?php echo ($info["iphei"]); ?>" class="layui-input">
					</div>
				</div-->
               	...
               	<label class="layui-form-label">提交IP黑名单：</label>
               <div class="col-sm-4">
                    <textarea style="width:235px;" placeholder="黑名单IP,多个用英文,号隔开" class="form-control" required name="data[iphei]"><?php echo ($info["iphei"]); ?></textarea>
