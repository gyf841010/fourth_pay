...
<div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">查看通道费率</h4>
                </div>
                <!-- End page title box -->
 <div class="row">
                    <div class="col-12">
                        <div class="card-box">
					<?php if($fans['status'] ==1): ?><table class="layui-table">
                    <thead>
                    <tr>
                          <th style="width:100px;">通道编码</th>
                        <th>通道名称</th>
                          <th>通道费率</th>
                       <th>结算方式</th>
                        <th>通道状态</th>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($p[t0feilv]*1000); ?>‰</td>
                               <td><?php if($tkconfig[t1zt] == 0): ?>T+0<?php elseif($tkconfig[t1zt] == 1): ?>T+1<?php endif; ?></td>
                            <td><?php if($p['status'] == 1): ?>开启<?php endif; ?></td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
                      <?php else: ?><div class="text-center"> <i class="icon-user-unfollow text-primary"></i>  商户未激活 无权限查看通道费率！</div><?php endif; ?>
            </div>
        </div>
    </div>
</div>
