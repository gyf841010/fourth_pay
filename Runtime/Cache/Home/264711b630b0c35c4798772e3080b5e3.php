    ...
    <div class="row">
        <div class="col-md-4 col-md-push-8">
            ...
            <form class="fh5co-form animate-box form-horizontal" data-animate-effect="fadeInRight" id="formlogin"
                  method="post" role="form" action="<?php echo ($user_checklogin); ?>">
            ...
            <div class="form-group">
                <span class="col-sm-4 mp-nm"><input type="text" class="form-control" id="verification" name="varification"  placeholder="验证码" required=""  aria-required="true" placeholder="Password" autocomplete="off" ajaxurl="<?php echo ($verifycode); ?>"></span>
                <label class="userverification col-sm-8"><img class="verifyimg" alt="点击刷新验证码" src="<?php echo ($verifycode); ?>?t=<?php echo time();?>" style="cursor:pointer;" onclick='getCode()' title="点击刷新验证码"></label>
            ...
            <div class="form-group">
                <p>还不是会员? 点击 <a href="<?php echo ($register); ?>">注册账号</a></p>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
    function getCode(){
        $(".verifyimg").attr("src","<?php echo ($verifycode); ?>?a=" + Math.random());
    }
</script>