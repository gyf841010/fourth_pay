    ...
    <div class="container login">
        ...
        <div class="line bouncein">
            ...
            <div class="xs6 xm4 xs3-move xm4-move">  
                ...
                <form action="<?php echo ($user_checklogin); ?>" id="defaultForm" method="post" class="layui-form">
                    <div class="panel loginbox">
                        <div class="text-center margin-big padding-big-top">
                            <div>
                                <img src="/Uploads/OK_Pay.png" style="height:70px;">
                            </div>
                            <h1 style="margin-top:10px;">欢迎商户登录</h1>
                        </div>
...
<script src="/Public/theme/view7/js/jquery.min.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
...
<script src="/Public/theme/view7/js/layui.all.js"></script>
</body>
</html>