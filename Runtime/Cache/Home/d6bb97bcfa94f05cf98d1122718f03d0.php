...
<h1 class="login-logo">
    <a href="/">
        <img src="<?php echo ($logo); ?>" style="height:60px;">
    </a>
</h1>
<div class="container login">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="<?php echo ($register_checkRegister); ?>" id="defaultForm" method="post" class="layui-form">
                    ...
                    <div class="panel-body" style="padding:30px;padding-top:0;">
                      ...
                      <?php if($siteconfig['invitecode'] == 1): ?><div class="form-group">
                        ...
                        <div class="form-group" style="margin-left:10px;">
                            ...
                            <a style="color:#0ae" href="javascript:void(0)" onclick="showAgree()">《<?php echo ($sitename); ?>业务合作协议》</a>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group register-now">
                            <div class="field">
                                <span>已有账号?</span>
                                <a href="<?php echo ($user_login); ?>" class="register-btn">立即登录</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="copy">
                <span><?php echo "Copyright © 2017-" . date("Y") . " "; echo ($sitename); ?> Rights Reserved.</span>
            </div>
        </div>
    </div>
</div>
<script src="/Public/theme/view10/layui.all.js"></script>
...
<script>
  ...
  <script>
    ...
    function showAgree() {
        layer.open({
            type: 2,
            title: '<?php echo ($sitename); ?>业务合作协议',
            area: ['900px', '500px'],
