...
! function (e) {
    ...
    i = {
        ...
        _cleanup: function () {
            ...
            var r, o, l, s, d, c, u, p, f, m, v, h = this,
            ...
            if (s.$caption.length) {
                if (a) n = e("<div>" + s.msgValidationError + "</div>").text(),
                    o = d.length, l = o ? 1 === o && d[0] ? s._getFileNames()[0] : s._getMsgSelected(o) : s._getMsgSelected(s.msgNo), r = '<span class="' + s.msgValidationErrorClass + '">' + s.msgValidationErrorIcon + (i.isEmpty(t) ? l : t) + "</span>";
                else {
