...
class CeshiController extends PayController {
    ...
    public function Pay($array) {
        ...
        $notifyurl = $this->_site . 'Pay_Ceshi_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_Ceshi_callbackurl.html'; //返回通知
        ...
        $GLOBALS['autth']= I('request.pay_attach');//jsontype
        $GLOBALS['json'] = I('request.jsontype');
        $pay_memberid = "7896865679";   //商户ID
        ...
        $Md5key = "lVJGmzBvQqWfbbd1bYzUa1vt29u06nzb";   //密钥
	...
	'handle_success_data'=>'success',   
       ...
       curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type:application/json'));
        ...
        if($GLOBALS['autth']=="json" || $GLOBALS['json'] =="json"){
        	echo $data;
        }else{
    ...
    public function notifyurl() {
        ...
        if($_SERVER['REMOTE_ADDR'] != "39.109.112.236"){
            ...
            if ($_REQUEST["is_finished"] == "1") {
        		...
        		$this->EditMoney($_REQUEST['job_number'], 'Ceshi', 0);
                   exit("OK");
            }
