...
function status($pay_status)
{
    switch ($pay_status) {
        case 0:
            return "<font  class='layui-badge-rim layui-btn-sm layui-bg-gray text-align:center;'>未付,未处理</font>";
            break;
        case 1:
            return "<font  class='layui-badge-rim layui-btn-sm layui-bg-blue text-align:center;'>成功,未通知</font>";
            break;
        case 2:
            return "<font  class='layui-badge-rim layui-btn-sm layui-bg-green text-align:center;'>成功,已通知</font>";
            break;
    }
}
 ...
 *记录向下游异步通知
 */
function log_server_notify($orderid, $url, $notifystr, $return) {
